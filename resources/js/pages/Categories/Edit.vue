                ...
                <form @submit.prevent="submit" class="p-6 space-y-5">
                    ...
                    <div>
                        ...
                        <input
                            ...
                            v-model="form.code"
                            type="text"
                            class="block w-full rounded-lg border border-gray-300 bg-white px-3 py-2 font-mono text-sm text-gray-900 focus:border-indigo-500 focus:outline-none focus:ring-1 focus:ring-indigo-500 dark:border-gray-600 dark:bg-gray-700 dark:text-white"
                        />
